...
| IK "K" extended (IQ5_K, IQ6_K) | ygg canonical IDs: IQ5_K=140, IQ6_K=141 | **ported** (Phase 5b-2 S1, 2026-05-24, `f7a489de5`) | CPU + CUDA/HIP on main. Imatrix required per PM-15. Vulkan parity in-flight (S2). |
