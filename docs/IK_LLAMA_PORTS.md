...
| IK "K" extended (IQ5_K, IQ6_K) | ygg canonical IDs: IQ5_K=140, IQ6_K=141 | **ported** (Phase 5b-2 S1, 2026-05-24, `f7a489de5`) | CPU + CUDA/HIP + Vulkan on main. Imatrix required per PM-15. Vulkan parity in-flight. |
| IK "K-L" extended (IQ2_KL) | ygg canonical ID: IQ2_KL=157 | **ported** (Phase 5b-1c S1, 2026-05-24, `e404274b9`) | 2.6875 bpw ultra-low-bitrate. CPU + CUDA/HIP on main. Vulkan parity in-flight. Imatrix required per PM-15. |
