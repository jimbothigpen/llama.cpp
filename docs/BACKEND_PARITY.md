...
| Trellis weight quants (IQ3_KT, IQ1_KT) | 5 (Trellis P3b, P3c) | **RELEASED** — IQ3_KT CPU+ROCm+Vulkan (enum 154, ftype 54); IQ1_KT queued | **RELEASED** — Vulkan dequant + mul_mat_vec shaders (main) | Cross-backend PPL parity gate pending (TODO 167) |
