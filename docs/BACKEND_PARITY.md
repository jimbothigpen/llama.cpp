...
| Trellis weight quants (IQ3_KT, IQ1_KT) | 5 (Trellis P3b, P3c) | **RELEASED** — IQ3_KT CPU+ROCm+Vulkan (`c809225f6`, TODO 168 CLOSED — gfx1150 GPU 99% util / 7.66s-pass; gfx1102 warmup crash is a separate Tensile confound); IQ1_KT queued | **RELEASED** — Vulkan dequant + mul_mat_vec shaders (main) | TODO 167 RESOLVED on Vulkan: IQ3_KT 8.4299 / IQ3_K 6.8348 (9B, 20ch); ROCm gfx1150 PASS (TODO 168 CLOSED) |
