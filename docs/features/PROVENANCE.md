...
| TurboKV prefill optimization (turboq2/turboq4, D=128) | **this fork** (tiled cooperative flash-attn decode for turboq2/4; `cols_per_block` dispatch; §-FLAG-DIM-256 — inert on hd=256 production models, e.g. Qwen3.5/3.6) | n/a | n/a | this fork | n/a | `ggml/src/ggml-cuda/fattn-common.cuh`, `ggml/src/ggml-cuda/fattn-vec.cuh` (branch `feature/turbo-kv-prefill-fix-2026-06-22`) | — | 2026-06-23 | VERIFIED |
...
| TurboQuant 5/6-bit KV (turboq5/turboq6, slots 64–65) | this fork (FWHT uniform-grid, TODO 250) | **DORMANT** — measured NO-WIN (PPL ties mainline KV types within σ; PP throughput −31%/−26%); implementation preserved on `feature/turboq56-kv-implement-2026-06-22`; feature doc [turboquant-hibit-kv.md](turboquant-hibit-kv.md) (on branch) |
