...
| EAGLE3 | carlosfundora/llama.cpp-1-bit-turbo (original arch); native-vs-fork reconciled 2026-06-13 — mainline ggml-org PR #18039 (`88a39274e`) adopted wholesale via Path-A merge `9d0602368`, fork's parallel arch retired | `conversion/llama.py` (full-vocab); `conversion/eagle3.py` REQUIRED for compact-vocab | SpecForge drafter checkpoints (external) | carlosfundora + mainline ggml-org | Path-A merge @ `9d0602368` (2026-06-13) | `src/models/eagle3.cpp` (fc_norm + GGUF-key-backcompat additive patches, this fork) | [eagle3.md](eagle3.md) | 2026-06-30 | VERIFIED |
