...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_BACKBONE_HIDDEN_SIZE,              "%s.backbone_hidden_size"              },
    { LLM_KV_ASSISTANT_NUM_CENTROIDS,           "%s.assistant.num_centroids"           },
    { LLM_KV_ASSISTANT_CENTROID_TOP_K,          "%s.assistant.centroid_intermediate_top_k" },
    { LLM_KV_ASSISTANT_USE_ORDERED_EMBEDDINGS,  "%s.assistant.use_ordered_embeddings"  },
