...
const char * llama_ftype_name(llama_ftype ftype) {
    ...
    switch ((enum llama_ftype) (ftype & ~LLAMA_FTYPE_GUESSED)) {
        ...
        case LLAMA_FTYPE_MOSTLY_WHT3_0:    name = LLAMA_FTYPE_PREFIX "WHT3_0 - 4.0 bpw WHT-rotated 3-bit"; break;
        case LLAMA_FTYPE_MOSTLY_WHT4_0:    name = LLAMA_FTYPE_PREFIX "WHT4_0 - 5.0 bpw WHT-rotated 4-bit"; break;
        case LLAMA_FTYPE_MOSTLY_WHT5_0:    name = LLAMA_FTYPE_PREFIX "WHT5_0 - 6.0 bpw WHT-rotated 5-bit"; break;
        ...
        case LLAMA_FTYPE_MOSTLY_IQ2_KL:    name = LLAMA_FTYPE_PREFIX "IQ2_KL - 2.6875 bpw ik_llama row-meta large"; break;
        case LLAMA_FTYPE_MOSTLY_IQ4_KS:    name = LLAMA_FTYPE_PREFIX "IQ4_KS - 4.25 bpw ik_llama row-meta 4-bit small"; break;
        case LLAMA_FTYPE_MOSTLY_IQ5_KS:    name = LLAMA_FTYPE_PREFIX "IQ5_KS - 5.25 bpw ik_llama row-meta 5-bit small"; break;
        case LLAMA_FTYPE_MOSTLY_IQ3_KS:    name = LLAMA_FTYPE_PREFIX "IQ3_KS - 3.1875 bpw ik_llama row-meta 3-bit small"; break;
        case LLAMA_FTYPE_MOSTLY_IQ2_KS:    name = LLAMA_FTYPE_PREFIX "IQ2_KS - 2.1875 bpw ik_llama row-meta 2-bit small"; break;
        case LLAMA_FTYPE_MOSTLY_IQ4_KSS:   name = LLAMA_FTYPE_PREFIX "IQ4_KSS - 4.0 bpw ik_llama row-meta 4-bit super-small"; break;
        case LLAMA_FTYPE_MOSTLY_IQ1_KT:    name = LLAMA_FTYPE_PREFIX "IQ1_KT - 1.75 bpw ik_llama row-meta trellis 1-bit"; break;
        case LLAMA_FTYPE_MOSTLY_IQ2_KT:    name = LLAMA_FTYPE_PREFIX "IQ2_KT - 2.0 bpw ik_llama row-meta trellis 2-bit"; break;
        case LLAMA_FTYPE_MOSTLY_IQ3_KT:    name = LLAMA_FTYPE_PREFIX "IQ3_KT - 3.0 bpw ik_llama row-meta trellis 3-bit"; break;
        case LLAMA_FTYPE_MOSTLY_IQ4_KT:    name = LLAMA_FTYPE_PREFIX "IQ4_KT - 4.0 bpw ik_llama row-meta trellis 4-bit"; break;
        case LLAMA_FTYPE_MOSTLY_IQ5_K:     name = LLAMA_FTYPE_PREFIX "IQ5_K - 5.50 bpw ik_llama imatrix 5-bit"; break;
        case LLAMA_FTYPE_MOSTLY_IQ6_K:     name = LLAMA_FTYPE_PREFIX "IQ6_K - 6.625 bpw ik_llama imatrix 6-bit"; break;
...
llama_model_loader::llama_model_loader(
    ...
    // TODO: make optional
    {
        ...
        switch (type_max) {
            ...
            case GGML_TYPE_WHT5_0:  ftype = LLAMA_FTYPE_MOSTLY_WHT5_0;  break;
            case GGML_TYPE_WHT6_0:  ftype = LLAMA_FTYPE_MOSTLY_WHT6_0;  break;
            case GGML_TYPE_WHT8_0:  ftype = LLAMA_FTYPE_MOSTLY_WHT8_0;  break;
