...
enum llm_kv {
    ...
    LLM_KV_BACKBONE_HIDDEN_SIZE,
    LLM_KV_ASSISTANT_NUM_CENTROIDS,
    LLM_KV_ASSISTANT_CENTROID_TOP_K,
    LLM_KV_ASSISTANT_USE_ORDERED_EMBEDDINGS,
...
enum llm_tensor {
    ...
    LLM_TENSOR_ASSIST_PRE_PROJ,         // gemma4_assistant
    LLM_TENSOR_ASSIST_POST_PROJ,        // gemma4_assistant
    LLM_TENSOR_ASSIST_EMBED_CENTROIDS,  // gemma4_assistant
    LLM_TENSOR_ASSIST_TOKEN_ORDERING,   // gemma4_assistant (i32 buffer; vocab permutation)
    // ZAYA1 CCA attention + residual scale + MoE router
    LLM_TENSOR_CCA_CONV_DW,
    LLM_TENSOR_CCA_CONV_DW_B,
    LLM_TENSOR_CCA_CONV_GRP,
    LLM_TENSOR_CCA_QK_NORM,
    LLM_TENSOR_CCA_K_SCALE,
    LLM_TENSOR_CCA_VAL_PROJ1,
    LLM_TENSOR_CCA_VAL_PROJ2,
    LLM_TENSOR_RES_SCALE_HS,
    LLM_TENSOR_RES_SCALE_HS_B,
    LLM_TENSOR_RES_SCALE_RES,
    LLM_TENSOR_RES_SCALE_RES_B,
    LLM_TENSOR_RES_SCALE_HS_FINAL,
    LLM_TENSOR_RES_SCALE_HS_B_FINAL,
    LLM_TENSOR_RES_SCALE_RES_FINAL,
    LLM_TENSOR_RES_SCALE_RES_B_FINAL,
    LLM_TENSOR_ZAYA_ROUTER_DOWN,
    LLM_TENSOR_ZAYA_ROUTER_DOWN_B,
    LLM_TENSOR_ZAYA_ROUTER_NORM,
    LLM_TENSOR_ZAYA_ROUTER_MLP0,
    LLM_TENSOR_ZAYA_ROUTER_MLP0_B,
    LLM_TENSOR_ZAYA_ROUTER_MLP2,
    LLM_TENSOR_ZAYA_ROUTER_MLP2_B,
    LLM_TENSOR_ZAYA_ROUTER_MLP4,
    LLM_TENSOR_ZAYA_ROUTER_BIASES,
    LLM_TENSOR_ZAYA_ROUTER_EDA_SCALE,
};
