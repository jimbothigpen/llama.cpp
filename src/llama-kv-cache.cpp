...
llama_kv_cache::llama_kv_cache(
    ...
    for (uint32_t il = 0; il < n_layer; il++) {
        ...
        const bool is_turbo_type = (type_k == GGML_TYPE_TURBOQ2_0 || type_k == GGML_TYPE_TURBOQ3_0 || type_k == GGML_TYPE_TURBOQ4_0 || type_k == GGML_TYPE_TURBOQ8_0 || type_k == GGML_TYPE_TURBOQ5_0 || type_k == GGML_TYPE_TURBOQ6_0 || type_k == GGML_TYPE_TURBOQ2_TCQ || type_k == GGML_TYPE_TURBOQ3_TCQ || ggml_type_is_turboq_innerq(type_k) || type_k == GGML_TYPE_KV_OSCAR_INT2 ||
                                    type_v == GGML_TYPE_TURBOQ2_0 || type_v == GGML_TYPE_TURBOQ3_0 || type_v == GGML_TYPE_TURBOQ4_0 || type_v == GGML_TYPE_TURBOQ8_0 || type_v == GGML_TYPE_TURBOQ5_0 || type_v == GGML_TYPE_TURBOQ6_0 || type_v == GGML_TYPE_TURBOQ2_TCQ || type_v == GGML_TYPE_TURBOQ3_TCQ || ggml_type_is_turboq_innerq(type_v) || type_v == GGML_TYPE_KV_OSCAR_INT2);
        ...
        ggml_type layer_type_v = type_v;
        {
            ...
            const bool is_turbo = (type_k == GGML_TYPE_TURBOQ2_0 || type_k == GGML_TYPE_TURBOQ3_0 || type_k == GGML_TYPE_TURBOQ4_0 || type_k == GGML_TYPE_TURBOQ8_0 || type_k == GGML_TYPE_TURBOQ5_0 || type_k == GGML_TYPE_TURBOQ6_0 || type_k == GGML_TYPE_TURBOQ2_TCQ || type_k == GGML_TYPE_TURBOQ3_TCQ || ggml_type_is_turboq_innerq(type_k) || type_k == GGML_TYPE_KV_OSCAR_INT2);
            const bool v_is_turbo = (type_v == GGML_TYPE_TURBOQ2_0 || type_v == GGML_TYPE_TURBOQ3_0 || type_v == GGML_TYPE_TURBOQ4_0 || type_v == GGML_TYPE_TURBOQ8_0 || type_v == GGML_TYPE_TURBOQ5_0 || type_v == GGML_TYPE_TURBOQ6_0 || type_v == GGML_TYPE_TURBOQ2_TCQ || type_v == GGML_TYPE_TURBOQ3_TCQ || ggml_type_is_turboq_innerq(type_v) || type_v == GGML_TYPE_KV_OSCAR_INT2);
