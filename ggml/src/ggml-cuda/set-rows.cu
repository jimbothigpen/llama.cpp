...
static void set_rows_cuda(ggml_backend_cuda_context & ctx, const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ...
    } else if (dst->type == GGML_TYPE_RQ_PLANAR3_0) {
        set_rows_cuda_quant<idx_t, block_planar3_0, QK_PLANAR3, quantize_f32_planar3_0_block>(
    ...
    } else if (dst->type == GGML_TYPE_RQ_PLANAR4_0) {
        set_rows_cuda_quant<idx_t, block_planar4_0, QK_PLANAR4, quantize_f32_planar4_0_block>(
    ...
    } else if (dst->type == GGML_TYPE_RQ_ISO3_0) {
        set_rows_cuda_quant<idx_t, block_iso3_0, QK_ISO3, quantize_f32_iso3_0_block>(
    ...
    } else if (dst->type == GGML_TYPE_RQ_ISO4_0) {
        set_rows_cuda_quant<idx_t, block_iso4_0, QK_ISO4, quantize_f32_iso4_0_block>(
