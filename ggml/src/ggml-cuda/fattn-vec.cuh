...
static __global__ void flash_attn_ext_vec(
    ...
    constexpr bool K_is_unquantized = (type_K == GGML_TYPE_F16 || type_K == GGML_TYPE_BF16 || type_K == GGML_TYPE_TURBOQ2_0 || type_K == GGML_TYPE_TURBOQ3_0 || type_K == GGML_TYPE_TURBOQ4_0 || type_K == GGML_TYPE_TURBOQ8_0 || type_K == GGML_TYPE_TURBOQ5_0 || type_K == GGML_TYPE_TURBOQ6_0 || type_K == GGML_TYPE_TURBOQ2_TCQ || type_K == GGML_TYPE_TURBOQ3_TCQ || type_K == GGML_TYPE_KV_OSCAR_INT2);
    ...
    constexpr bool K_is_turbo = (type_K == GGML_TYPE_TURBOQ2_0 || type_K == GGML_TYPE_TURBOQ3_0 || type_K == GGML_TYPE_TURBOQ4_0 || type_K == GGML_TYPE_TURBOQ8_0 || type_K == GGML_TYPE_TURBOQ5_0 || type_K == GGML_TYPE_TURBOQ6_0 || type_K == GGML_TYPE_TURBOQ2_TCQ || type_K == GGML_TYPE_TURBOQ3_TCQ || type_K == GGML_TYPE_KV_OSCAR_INT2);
    ...
    if constexpr (tcq_smem_cb_size > 0) {
        const float * cb_src = tcq_is_tcq3 ? d_turboq3_tcq_codebook : d_turboq2_tcq_codebook;
        for (int i = tid; i < tcq_smem_cb_size; i += nthreads) {
            tcq_smem_codebook[i] = cb_src[i];
        }
        __syncthreads();
    }
    ...
    constexpr int n_centroids_lut = (D <= 256 && type_K == GGML_TYPE_TURBOQ3_0) ? 8 :
                                    (D <= 256 && type_K == GGML_TYPE_TURBOQ2_0) ? 4 :
                                    0;
...
#pragma unroll
    ...
    if constexpr (n_centroids_lut > 0 && ncols == 1) {
        const float * centroids_ptr = (type_K == GGML_TYPE_TURBOQ3_0) ? TURBO_CENTROIDS_3BIT :
            ...
            for (int j = 0; j < ncols; ++j) {
                ...
                if constexpr (turbo_tiled) {
                    ...
                    for (int d0 = 0; d0 < D; d0 += 8) {
                        const int ib = d0 / QK_TURBOQ3;
                        const int jj = d0 % QK_TURBOQ3;
                ...
                } else if constexpr (n_centroids_lut > 0 && ncols == 1 && type_K == GGML_TYPE_TURBOQ2_0) {
                    // LUT scoring for turboq2: 8 elements per iteration (2 qs bytes, no signs)
                    const block_turboq2_0 * K_turbo = (const block_turboq2_0 *)(K + i_KQ*nb11);
                    sum = 0.0f;
                    for (int d0 = 0; d0 < D; d0 += 8) {
                        const int ib = d0 / QK_TURBOQ2;
                        const int jj = d0 % QK_TURBOQ2;
                        const float norm = __half2float(K_turbo[ib].norm);
                        const uint8_t qs0 = K_turbo[ib].qs[jj / 4];
                        const uint8_t qs1 = K_turbo[ib].qs[jj / 4 + 1];
...
#pragma unroll
            ...
            if constexpr (type_V == GGML_TYPE_TURBOQ2_0) {
                const block_turboq2_0 * vb = (const block_turboq2_0 *)(V + k*nb21);
                int prev_ib = -1;
                float sc[4];
...
#pragma unroll
                ...
                const block_turboq3_0 * vb = (const block_turboq3_0 *)(V + k*nb21);
                int prev_ib = -1;
                float sc[8];
...
#pragma unroll
                for (int i_VKQ_0 = 0; i_VKQ_0 < D/2; i_VKQ_0 += nthreads_V*V_rows_per_thread/2) {
                    const int i0 = 2*i_VKQ_0 + (threadIdx.x % nthreads_V)*V_rows_per_thread;
                    const int ib = i0 / QK_TURBOQ3;
                    const int j0 = i0 % QK_TURBOQ3;
...
#pragma unroll
                ...
                const block_turboq4_0 * vb = (const block_turboq4_0 *)(V + k*nb21);
                int prev_ib = -1;
                float sc[16];
...
#pragma unroll
                for (int i_VKQ_0 = 0; i_VKQ_0 < D/2; i_VKQ_0 += nthreads_V*V_rows_per_thread/2) {
                    const int i0 = 2*i_VKQ_0 + (threadIdx.x % nthreads_V)*V_rows_per_thread;
                    const int ib = i0 / QK_TURBOQ4;
                    const int j0 = i0 % QK_TURBOQ4;
...
EXTERN_DECL_FATTN_VEC_CASES( 64, GGML_TYPE_Q1_0)
EXTERN_DECL_FATTN_VEC_CASES(128, GGML_TYPE_Q1_0)
EXTERN_DECL_FATTN_VEC_CASES(256, GGML_TYPE_Q1_0)

extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_F16,  GGML_TYPE_Q1_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_F16,  GGML_TYPE_Q1_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_F16,  GGML_TYPE_Q1_0);
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_Q1_0, GGML_TYPE_Q1_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_Q1_0, GGML_TYPE_Q1_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_Q1_0, GGML_TYPE_Q1_0);
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_Q8_0, GGML_TYPE_Q1_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_Q8_0, GGML_TYPE_Q1_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_Q8_0, GGML_TYPE_Q1_0);

// TurboQuant3 — turbo3 K + turbo3 V (KV cache uses same type)
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ3_0, GGML_TYPE_TURBOQ3_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ3_0, GGML_TYPE_TURBOQ3_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ3_0, GGML_TYPE_TURBOQ3_0);

// Mixed turbo3/q8_0 KV cache types
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ3_0, GGML_TYPE_Q8_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ3_0, GGML_TYPE_Q8_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ3_0, GGML_TYPE_Q8_0);

extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_Q8_0, GGML_TYPE_TURBOQ3_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_Q8_0, GGML_TYPE_TURBOQ3_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_Q8_0, GGML_TYPE_TURBOQ3_0);

// Mixed f16/turbo3 KV cache types
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_F16, GGML_TYPE_TURBOQ3_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_F16, GGML_TYPE_TURBOQ3_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_F16, GGML_TYPE_TURBOQ3_0);

extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ3_0, GGML_TYPE_F16);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ3_0, GGML_TYPE_F16);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ3_0, GGML_TYPE_F16);

// TurboQuant2 — turbo2 K + turbo2 V (KV cache uses same type)
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ2_0, GGML_TYPE_TURBOQ2_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ2_0, GGML_TYPE_TURBOQ2_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ2_0, GGML_TYPE_TURBOQ2_0);

// Mixed turbo2/q8_0 KV cache types
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ2_0, GGML_TYPE_Q8_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ2_0, GGML_TYPE_Q8_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ2_0, GGML_TYPE_Q8_0);

extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_Q8_0, GGML_TYPE_TURBOQ2_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_Q8_0, GGML_TYPE_TURBOQ2_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_Q8_0, GGML_TYPE_TURBOQ2_0);

// Mixed f16/turbo2 KV cache types
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_F16, GGML_TYPE_TURBOQ2_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_F16, GGML_TYPE_TURBOQ2_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_F16, GGML_TYPE_TURBOQ2_0);

extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ2_0, GGML_TYPE_F16);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ2_0, GGML_TYPE_F16);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ2_0, GGML_TYPE_F16);

// Mixed turbo3/turbo2 KV cache types
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ3_0, GGML_TYPE_TURBOQ2_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ3_0, GGML_TYPE_TURBOQ2_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ3_0, GGML_TYPE_TURBOQ2_0);

extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ2_0, GGML_TYPE_TURBOQ3_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ2_0, GGML_TYPE_TURBOQ3_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ2_0, GGML_TYPE_TURBOQ3_0);

// TurboQuant4 — turbo4 K + turbo4 V (KV cache uses same type)
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ4_0, GGML_TYPE_TURBOQ4_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ4_0, GGML_TYPE_TURBOQ4_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ4_0, GGML_TYPE_TURBOQ4_0);

// Mixed turbo4/q8_0 KV cache types
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ4_0, GGML_TYPE_Q8_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ4_0, GGML_TYPE_Q8_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ4_0, GGML_TYPE_Q8_0);

extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_Q8_0, GGML_TYPE_TURBOQ4_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_Q8_0, GGML_TYPE_TURBOQ4_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_Q8_0, GGML_TYPE_TURBOQ4_0);

// Mixed f16/turbo4 KV cache types
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_F16, GGML_TYPE_TURBOQ4_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_F16, GGML_TYPE_TURBOQ4_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_F16, GGML_TYPE_TURBOQ4_0);

extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ4_0, GGML_TYPE_F16);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ4_0, GGML_TYPE_F16);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ4_0, GGML_TYPE_F16);

// Mixed turbo4/turbo3 KV cache types
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ4_0, GGML_TYPE_TURBOQ3_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ4_0, GGML_TYPE_TURBOQ3_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ4_0, GGML_TYPE_TURBOQ3_0);

extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ3_0, GGML_TYPE_TURBOQ4_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ3_0, GGML_TYPE_TURBOQ4_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ3_0, GGML_TYPE_TURBOQ4_0);

// Mixed turbo4/turbo2 KV cache types
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ4_0, GGML_TYPE_TURBOQ2_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ4_0, GGML_TYPE_TURBOQ2_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ4_0, GGML_TYPE_TURBOQ2_0);
...
// TurboQuant8 — turbo8 K + turbo8 V (KV cache uses same type)
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ8_0, GGML_TYPE_TURBOQ8_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ8_0, GGML_TYPE_TURBOQ8_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ8_0, GGML_TYPE_TURBOQ8_0);
// Mixed turbo8/q8_0
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ8_0, GGML_TYPE_Q8_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ8_0, GGML_TYPE_Q8_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ8_0, GGML_TYPE_Q8_0);
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_Q8_0, GGML_TYPE_TURBOQ8_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_Q8_0, GGML_TYPE_TURBOQ8_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_Q8_0, GGML_TYPE_TURBOQ8_0);
// Mixed f16/turbo8
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_F16, GGML_TYPE_TURBOQ8_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_F16, GGML_TYPE_TURBOQ8_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_F16, GGML_TYPE_TURBOQ8_0);
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ8_0, GGML_TYPE_F16);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ8_0, GGML_TYPE_F16);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ8_0, GGML_TYPE_F16);
// bf16 K × turbo8 V
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_BF16, GGML_TYPE_TURBOQ8_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_BF16, GGML_TYPE_TURBOQ8_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_BF16, GGML_TYPE_TURBOQ8_0);
// Asymmetric K=turbo8 × lower-bpw V (turbo8-K/turbo4-V = 6.124 bpw sweet spot)
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ8_0, GGML_TYPE_TURBOQ4_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ8_0, GGML_TYPE_TURBOQ4_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ8_0, GGML_TYPE_TURBOQ4_0);
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ8_0, GGML_TYPE_TURBOQ3_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ8_0, GGML_TYPE_TURBOQ3_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ8_0, GGML_TYPE_TURBOQ3_0);
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ8_0, GGML_TYPE_TURBOQ2_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ8_0, GGML_TYPE_TURBOQ2_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ8_0, GGML_TYPE_TURBOQ2_0);

// TurboQuant5/6 KV cache (invented ygg TODO 250) — self-pairs + mixed f16/q8_0 + 5/6 cross, D=64/128/256
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ5_0, GGML_TYPE_TURBOQ5_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ5_0, GGML_TYPE_TURBOQ5_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ5_0, GGML_TYPE_TURBOQ5_0);
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ5_0, GGML_TYPE_F16);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ5_0, GGML_TYPE_F16);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ5_0, GGML_TYPE_F16);
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_F16, GGML_TYPE_TURBOQ5_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_F16, GGML_TYPE_TURBOQ5_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_F16, GGML_TYPE_TURBOQ5_0);
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ5_0, GGML_TYPE_Q8_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ5_0, GGML_TYPE_Q8_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ5_0, GGML_TYPE_Q8_0);
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_Q8_0, GGML_TYPE_TURBOQ5_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_Q8_0, GGML_TYPE_TURBOQ5_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_Q8_0, GGML_TYPE_TURBOQ5_0);
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ6_0, GGML_TYPE_TURBOQ6_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ6_0, GGML_TYPE_TURBOQ6_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ6_0, GGML_TYPE_TURBOQ6_0);
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ6_0, GGML_TYPE_F16);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ6_0, GGML_TYPE_F16);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ6_0, GGML_TYPE_F16);
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_F16, GGML_TYPE_TURBOQ6_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_F16, GGML_TYPE_TURBOQ6_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_F16, GGML_TYPE_TURBOQ6_0);
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ6_0, GGML_TYPE_Q8_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ6_0, GGML_TYPE_Q8_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ6_0, GGML_TYPE_Q8_0);
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_Q8_0, GGML_TYPE_TURBOQ6_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_Q8_0, GGML_TYPE_TURBOQ6_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_Q8_0, GGML_TYPE_TURBOQ6_0);
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ6_0, GGML_TYPE_TURBOQ5_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ6_0, GGML_TYPE_TURBOQ5_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ6_0, GGML_TYPE_TURBOQ5_0);
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_TURBOQ5_0, GGML_TYPE_TURBOQ6_0);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ5_0, GGML_TYPE_TURBOQ6_0);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ5_0, GGML_TYPE_TURBOQ6_0);
...
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ2_0, GGML_TYPE_TURBOQ2_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ2_0, GGML_TYPE_Q8_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_Q8_0,      GGML_TYPE_TURBOQ2_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_F16,       GGML_TYPE_TURBOQ2_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ2_0, GGML_TYPE_F16);

extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ3_0, GGML_TYPE_TURBOQ3_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ3_0, GGML_TYPE_Q8_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_Q8_0,      GGML_TYPE_TURBOQ3_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_F16,       GGML_TYPE_TURBOQ3_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ3_0, GGML_TYPE_F16);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ2_0, GGML_TYPE_TURBOQ3_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ3_0, GGML_TYPE_TURBOQ2_0);

extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ4_0, GGML_TYPE_TURBOQ4_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ4_0, GGML_TYPE_Q8_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_Q8_0,      GGML_TYPE_TURBOQ4_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_F16,       GGML_TYPE_TURBOQ4_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ4_0, GGML_TYPE_F16);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ3_0, GGML_TYPE_TURBOQ4_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ4_0, GGML_TYPE_TURBOQ3_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ2_0, GGML_TYPE_TURBOQ4_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ4_0, GGML_TYPE_TURBOQ2_0);

extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ8_0, GGML_TYPE_TURBOQ8_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ8_0, GGML_TYPE_Q8_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_Q8_0,      GGML_TYPE_TURBOQ8_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_F16,       GGML_TYPE_TURBOQ8_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ8_0, GGML_TYPE_F16);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_BF16,      GGML_TYPE_TURBOQ8_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ8_0, GGML_TYPE_TURBOQ4_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ8_0, GGML_TYPE_TURBOQ3_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ8_0, GGML_TYPE_TURBOQ2_0);
// TurboQuant5/6 KV cache (invented ygg TODO 250) — D=512 instances (NO_DEVICE_CODE stub on sm<80)
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ5_0, GGML_TYPE_TURBOQ5_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ5_0, GGML_TYPE_F16);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_F16,       GGML_TYPE_TURBOQ5_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ5_0, GGML_TYPE_Q8_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_Q8_0,      GGML_TYPE_TURBOQ5_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ6_0, GGML_TYPE_TURBOQ6_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ6_0, GGML_TYPE_F16);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_F16,       GGML_TYPE_TURBOQ6_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ6_0, GGML_TYPE_Q8_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_Q8_0,      GGML_TYPE_TURBOQ6_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ6_0, GGML_TYPE_TURBOQ5_0);
extern DECL_FATTN_VEC_CASE(512, GGML_TYPE_TURBOQ5_0, GGML_TYPE_TURBOQ6_0);
...
// (D=128 and D=256). Plain INT2 affine V (no WHT, no inverse-WHT). Excludes K bpw < 2.25
// (turboq2/turboq2_tcq/q1_0 → K<V, not wired per the K>=V asymmetric directive).
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ3_0,     GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ3_0,     GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ3_TCQ,   GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ3_TCQ,   GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ4_0,     GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ4_0,     GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ5_0,     GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ5_0,     GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ6_0,     GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ6_0,     GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_TURBOQ8_0,     GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_TURBOQ8_0,     GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_Q4_0,          GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_Q4_0,          GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_Q4_1,          GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_Q4_1,          GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_Q5_0,          GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_Q5_0,          GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_Q5_1,          GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_Q5_1,          GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_Q8_0,          GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_Q8_0,          GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_IQ4_NL,        GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_IQ4_NL,        GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_F16,           GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_F16,           GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_BF16,          GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_BF16,          GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_KV_OSCAR_INT2, GGML_TYPE_KV_OSCAR_INT2);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_KV_OSCAR_INT2, GGML_TYPE_KV_OSCAR_INT2);
