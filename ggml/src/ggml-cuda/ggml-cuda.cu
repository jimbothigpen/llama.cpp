        ...
        case GGML_OP_SET_ROWS:
            {
                ...
                // turboq2/turboq4/turboq8 block size is 128, so head_dim must be divisible by 128
                if ((op->type == GGML_TYPE_TURBOQ2_0 || op->type == GGML_TYPE_TURBOQ4_0 || op->type == GGML_TYPE_TURBOQ8_0) && op->src[0]->ne[0] % 128 != 0) {
                    return false;
                }
