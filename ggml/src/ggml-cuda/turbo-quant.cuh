...
// WHT5/6/8 Lloyd-Max N(0,1) codebooks — MUST stay byte-identical to the CPU
// arrays in ggml-turbo-quant.c (WHT5_0_CENTROIDS / WHT6_0_CENTROIDS / WHT8_0_CENTROIDS):
// quantize runs on CPU, dequant runs here.
static __device__ float WHT5_CENTROIDS_WEIGHT[32] = {
...
static __device__ float WHT6_CENTROIDS_WEIGHT[64] = {
...
static __device__ float WHT8_CENTROIDS_WEIGHT[256] = {
