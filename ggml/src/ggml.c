...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_KV_OSCAR_INT2] = {
        .type_name                = "kv_oscar_int2",
        .blck_size                = QK_OSCAR_INT2,
        .type_size                = sizeof(block_kv_oscar_int2),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_kv_oscar_int2,
        .from_float_ref           = (ggml_from_float_t) quantize_row_kv_oscar_int2_ref,
    },
    ...
    [GGML_TYPE_WHT3_0] = {
        .type_name                = "wht3_0",
        .blck_size                = QK_TQ3_0,
        .type_size                = sizeof(block_wht3_0),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_wht3_0,
        .from_float_ref           = (ggml_from_float_t) quantize_row_wht3_0_ref,
    },
    [GGML_TYPE_WHT4_0] = {
        .type_name                = "wht4_0",
        .blck_size                = QK_WHT4_0,
        .type_size                = sizeof(block_wht4_0),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_wht4_0,
        .from_float_ref           = (ggml_from_float_t) quantize_row_wht4_0_ref,
    },
    [GGML_TYPE_WHT4_0_UNIFORM] = {
        .type_name                = "wht4_0_uniform",
        .blck_size                = QK_WHT4_0,
        .type_size                = sizeof(block_wht4_0),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_wht4_0_uniform,
        .from_float_ref           = (ggml_from_float_t) quantize_row_wht4_0_uniform_ref,
    },
    ...
    // Phase 5b-1b: row-meta KS family (row_meta_size set; P0 infra required)
    [GGML_TYPE_IQ4_KS] = {
        .type_name                = "iq4_ks",
        .blck_size                = QK_K,
...
struct ggml_tensor * ggml_turbo_wht(
    ...
    // op_params layout — pointer arithmetic mirrors turbo-wht.cu CUDA dispatch
    // (op_params is int32_t*, so `+ sizeof(int)` advances 4 elements = byte 16).
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_WHT4_0_UNIFORM:  result = quantize_wht4_0_uniform(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
