...
#define CREATE_MM2(PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT) \
        ...
        CREATE_MM2(pipeline_dequant_mul_mat_mat_f16[GGML_TYPE_Q1_0_G128], matmul_q1_0_g128_f16, mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3)
        ...
        CREATE_MM2(pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q1_0_G128], matmul_id_subgroup_q1_0_g128_f16, mmqid_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, 5)
...
#define CREATE_MM2(TYPE, PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT, ID) \
        ...
        if (device->coopmat_acc_f16_support) {
            ...
            CREATE_MM2(GGML_TYPE_Q1_0_G128, pipeline_dequant_mul_mat_mat[GGML_TYPE_Q1_0_G128], matmul_q1_0_g128_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, );
            ...
            CREATE_MM(GGML_TYPE_Q1_0_G128, pipeline_dequant_mul_mat_mat[GGML_TYPE_Q1_0_G128].f32acc, matmul_q1_0_g128_f32, , mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, );
        ...
        CREATE_MM2(GGML_TYPE_Q1_0_G128, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q1_0_G128], matmul_id_subgroup_q1_0_g128_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id);
...
#define CREATE_MM2(TYPE, PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT, ID, REQSUBGROUPSIZE) \
        ...
        CREATE_MM2(GGML_TYPE_Q1_0_G128, pipeline_dequant_mul_mat_mat[GGML_TYPE_Q1_0_G128], matmul_q1_0_g128_f32, mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, , 0);
        ...
        if (device->subgroup_ballot && device->subgroup_require_full_support && subgroup_min_size_16) {
            ...
            CREATE_MM2(GGML_TYPE_Q1_0_G128, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q1_0_G128], matmul_id_subgroup_q1_0_g128_f32, mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size);
            ...
            CREATE_MM2(GGML_TYPE_Q1_0_G128, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q1_0_G128], matmul_id_q1_0_g128_f32, mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
...
#define CREATE_MMQ(TYPE, PIPELINE_NAME, NAMELC, WG_DENOMS, WARPTILE, PUSHCONST, PARAMCOUNT, ID) \
        ...
        CREATE_MM(GGML_TYPE_Q1_0_G128, pipeline_dequant_mul_mat_mat[GGML_TYPE_Q1_0_G128].f32acc, matmul_q1_0_g128_f32, , mmq_wg_denoms, warptile_mmq, vk_mat_mat_push_constants, 3, , 0);
        ...
        if (device->subgroup_ballot && device->subgroup_require_full_support && subgroup_min_size_16) {
            ...
            CREATE_MM(GGML_TYPE_Q1_0_G128, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q1_0_G128].f32acc, matmul_id_subgroup_q1_0_g128_f32, , mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, mul_mat_subgroup_size);
            ...
            CREATE_MM(GGML_TYPE_Q1_0_G128, pipeline_dequant_mul_mat_mat_id[GGML_TYPE_Q1_0_G128].f32acc, matmul_id_q1_0_g128_f32, , mmq_wg_denoms, warptile_mmqid, vk_mat_mat_id_push_constants, mul_mat_id_param_count, _id, 0);
...
#undef CREATE_MM
    ...
    // WHT4_0 uses a dedicated pipeline whose workgroup size is always 32 and
    ...
    const uint32_t wht4_0_wg_size            = 32u;
    const uint32_t wht4_0_force_sg_size      = 0u;
    ...
    for (uint32_t w = 0; w < DMMV_WG_SIZE_COUNT; ++w) {
        ...
        for (uint32_t i = 0; i < mul_mat_vec_max_cols; ++i) {
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[w][GGML_TYPE_Q1_0_G128][i], "mul_mat_vec_q1_0_g128_f32_f32", arr_dmmv_q1_0_g128_f32_f32_len[reduc], arr_dmmv_q1_0_g128_f32_f32_data[reduc], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {2*rm_stdq, 1, 1}, {wg_size_subgroup, 2*rm_stdq, i+1}, 1, true, use_subgroups, force_subgroup_size);
            ...
            // WHT4_0: fixed 32-thread workgroup, shared-memory WHT butterfly,
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[w][GGML_TYPE_IQ4_KS][i],  "mul_mat_vec_iq4_ks_f32_f32",  arr_dmmv_iq4_ks_f32_f32_len[reduc16],  arr_dmmv_iq4_ks_f32_f32_data[reduc16],  "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[w][GGML_TYPE_IQ4_KSS][i], "mul_mat_vec_iq4_kss_f32_f32", arr_dmmv_iq4_kss_f32_f32_len[reduc16], arr_dmmv_iq4_kss_f32_f32_data[reduc16], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[w][GGML_TYPE_IQ2_KT][i],  "mul_mat_vec_iq2_kt_f32_f32",  arr_dmmv_iq2_kt_f32_f32_len[reduc16],  arr_dmmv_iq2_kt_f32_f32_data[reduc16],  "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[w][GGML_TYPE_IQ4_KT][i],  "mul_mat_vec_iq4_kt_f32_f32",  arr_dmmv_iq4_kt_f32_f32_len[reduc16],  arr_dmmv_iq4_kt_f32_f32_data[reduc16],  "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[w][GGML_TYPE_IQ3_KT][i],  "mul_mat_vec_iq3_kt_f32_f32",  arr_dmmv_iq3_kt_f32_f32_len[reduc16],  arr_dmmv_iq3_kt_f32_f32_data[reduc16],  "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[w][GGML_TYPE_IQ2_KL][i],  "mul_mat_vec_iq2_kl_f32_f32",  arr_dmmv_iq2_kl_f32_f32_len[reduc16],  arr_dmmv_iq2_kl_f32_f32_data[reduc16],  "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[w][GGML_TYPE_IQ5_K][i],   "mul_mat_vec_iq5_k_f32_f32",   arr_dmmv_iq5_k_f32_f32_len[reduc16],   arr_dmmv_iq5_k_f32_f32_data[reduc16],   "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f32_f32[w][GGML_TYPE_IQ6_K][i],   "mul_mat_vec_iq6_k_f32_f32",   arr_dmmv_iq6_k_f32_f32_len[reduc16],   arr_dmmv_iq6_k_f32_f32_data[reduc16],   "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[w][GGML_TYPE_Q1_0_G128][i], "mul_mat_vec_q1_0_g128_f16_f32", arr_dmmv_q1_0_g128_f16_f32_len[reduc], arr_dmmv_q1_0_g128_f16_f32_data[reduc], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {2*rm_stdq, 1, 1}, {wg_size_subgroup, 2*rm_stdq, i+1}, 1, true, use_subgroups, force_subgroup_size);
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[w][GGML_TYPE_IQ4_KSS][i], "mul_mat_vec_iq4_kss_f16_f32", arr_dmmv_iq4_kss_f16_f32_len[reduc16], arr_dmmv_iq4_kss_f16_f32_data[reduc16], "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[w][GGML_TYPE_IQ2_KT][i],  "mul_mat_vec_iq2_kt_f16_f32",  arr_dmmv_iq2_kt_f16_f32_len[reduc16],  arr_dmmv_iq2_kt_f16_f32_data[reduc16],  "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[w][GGML_TYPE_IQ4_KT][i],  "mul_mat_vec_iq4_kt_f16_f32",  arr_dmmv_iq4_kt_f16_f32_len[reduc16],  arr_dmmv_iq4_kt_f16_f32_data[reduc16],  "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[w][GGML_TYPE_IQ3_KT][i],  "mul_mat_vec_iq3_kt_f16_f32",  arr_dmmv_iq3_kt_f16_f32_len[reduc16],  arr_dmmv_iq3_kt_f16_f32_data[reduc16],  "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[w][GGML_TYPE_IQ2_KL][i],  "mul_mat_vec_iq2_kl_f16_f32",  arr_dmmv_iq2_kl_f16_f32_len[reduc16],  arr_dmmv_iq2_kl_f16_f32_data[reduc16],  "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ...
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[w][GGML_TYPE_IQ5_K][i],   "mul_mat_vec_iq5_k_f16_f32",   arr_dmmv_iq5_k_f16_f32_len[reduc16],   arr_dmmv_iq5_k_f16_f32_data[reduc16],   "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
            ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_f16_f32[w][GGML_TYPE_IQ6_K][i],   "mul_mat_vec_iq6_k_f16_f32",   arr_dmmv_iq6_k_f16_f32_len[reduc16],   arr_dmmv_iq6_k_f16_f32_data[reduc16],   "main", mul_mat_vec_num_bindings, sizeof(vk_mat_vec_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq, i+1}, 1, true, use_subgroups16, force_subgroup_size16);
        ...
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[w][GGML_TYPE_Q1_0_G128], "mul_mat_vec_id_q1_0_g128_f32", arr_dmmv_id_q1_0_g128_f32_f32_len[reduc], arr_dmmv_id_q1_0_g128_f32_f32_data[reduc], "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {2*rm_stdq, 1, 1}, {wg_size_subgroup, 2*rm_stdq}, 1, true, use_subgroups, force_subgroup_size);
        ...
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[w][GGML_TYPE_IQ5_K],   "mul_mat_vec_id_iq5_k_f32",   arr_dmmv_id_iq5_k_f32_f32_len[reduc16],   arr_dmmv_id_iq5_k_f32_f32_data[reduc16],   "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq}, 1, true, use_subgroups16, force_subgroup_size16);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[w][GGML_TYPE_IQ6_K],   "mul_mat_vec_id_iq6_k_f32",   arr_dmmv_id_iq6_k_f32_f32_len[reduc16],   arr_dmmv_id_iq6_k_f32_f32_data[reduc16],   "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq}, 1, true, use_subgroups16, force_subgroup_size16);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[w][GGML_TYPE_IQ3_KS],  "mul_mat_vec_id_iq3_ks_f32",  arr_dmmv_id_iq3_ks_f32_f32_len[reduc16],  arr_dmmv_id_iq3_ks_f32_f32_data[reduc16],  "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq}, 1, true, use_subgroups16, force_subgroup_size16);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[w][GGML_TYPE_IQ4_KS],  "mul_mat_vec_id_iq4_ks_f32",  arr_dmmv_id_iq4_ks_f32_f32_len[reduc16],  arr_dmmv_id_iq4_ks_f32_f32_data[reduc16],  "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq}, 1, true, use_subgroups16, force_subgroup_size16);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[w][GGML_TYPE_IQ4_KSS], "mul_mat_vec_id_iq4_kss_f32", arr_dmmv_id_iq4_kss_f32_f32_len[reduc16], arr_dmmv_id_iq4_kss_f32_f32_data[reduc16], "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq}, 1, true, use_subgroups16, force_subgroup_size16);
        ggml_vk_create_pipeline(device, device->pipeline_dequant_mul_mat_vec_id_f32[w][GGML_TYPE_IQ2_KT],  "mul_mat_vec_id_iq2_kt_f32",  arr_dmmv_id_iq2_kt_f32_f32_len[reduc16],  arr_dmmv_id_iq2_kt_f32_f32_data[reduc16],  "main", mul_mat_vec_id_num_bindings, sizeof(vk_mat_vec_id_push_constants), {rm_kq, 1, 1}, {wg_size_subgroup16, rm_kq}, 1, true, use_subgroups16, force_subgroup_size16);
    ...
    ggml_vk_create_pipeline(device, device->pipeline_dequant[GGML_TYPE_Q1_0_G128], "dequant_q1_0_g128", dequant_q1_0_g128_len, dequant_q1_0_g128_data, "main", 2, 5 * sizeof(uint32_t), {256 * 8, 1, 1}, {}, 1);
    ...
    ggml_vk_create_pipeline(device, device->pipeline_dequant[GGML_TYPE_IQ5_K],   "dequant_iq5_k",   dequant_iq5_k_len,   dequant_iq5_k_data,   "main", 2, 5 * sizeof(uint32_t), {256, 1, 1}, {}, 1);
    ggml_vk_create_pipeline(device, device->pipeline_dequant[GGML_TYPE_IQ6_K],   "dequant_iq6_k",   dequant_iq6_k_len,   dequant_iq6_k_data,   "main", 2, 5 * sizeof(uint32_t), {256, 1, 1}, {}, 1);
    // KS/KL-family dequant: one WG per 256-element super-block, 64 threads each.
    ggml_vk_create_pipeline(device, device->pipeline_dequant[GGML_TYPE_IQ3_KS],  "dequant_iq3_ks",  dequant_iq3_ks_len,  dequant_iq3_ks_data,  "main", 2, 5 * sizeof(uint32_t), {256, 1, 1}, {}, 1);
    ggml_vk_create_pipeline(device, device->pipeline_dequant[GGML_TYPE_IQ4_KS],  "dequant_iq4_ks",  dequant_iq4_ks_len,  dequant_iq4_ks_data,  "main", 2, 5 * sizeof(uint32_t), {256, 1, 1}, {}, 1);
    ggml_vk_create_pipeline(device, device->pipeline_dequant[GGML_TYPE_IQ4_KSS], "dequant_iq4_kss", dequant_iq4_kss_len, dequant_iq4_kss_data, "main", 2, 5 * sizeof(uint32_t), {256, 1, 1}, {}, 1);
    ggml_vk_create_pipeline(device, device->pipeline_dequant[GGML_TYPE_IQ2_KT],  "dequant_iq2_kt",  dequant_iq2_kt_len,  dequant_iq2_kt_data,  "main", 2, 5 * sizeof(uint32_t), {256, 1, 1}, {}, 1);
    ggml_vk_create_pipeline(device, device->pipeline_dequant[GGML_TYPE_IQ4_KT],  "dequant_iq4_kt",  dequant_iq4_kt_len,  dequant_iq4_kt_data,  "main", 2, 5 * sizeof(uint32_t), {256, 1, 1}, {}, 1);
    ggml_vk_create_pipeline(device, device->pipeline_dequant[GGML_TYPE_IQ3_KT],  "dequant_iq3_kt",  dequant_iq3_kt_len,  dequant_iq3_kt_data,  "main", 2, 5 * sizeof(uint32_t), {256, 1, 1}, {}, 1);
    ggml_vk_create_pipeline(device, device->pipeline_dequant[GGML_TYPE_IQ2_KL],  "dequant_iq2_kl",  dequant_iq2_kl_len,  dequant_iq2_kl_data,  "main", 2, 5 * sizeof(uint32_t), {256, 1, 1}, {}, 1);
    ...
    ggml_vk_create_pipeline(device, device->pipeline_get_rows[GGML_TYPE_Q1_0_G128], "get_rows_q1_0_g128", get_rows_q1_0_g128_len, get_rows_q1_0_g128_data, "main", 3, sizeof(vk_op_binary_push_constants), {1024, 1, 1}, {}, 1);
    ...
    ggml_vk_create_pipeline(device, device->pipeline_get_rows_f32[GGML_TYPE_Q1_0_G128], "get_rows_q1_0_g128_f32", get_rows_q1_0_g128_f32_len, get_rows_q1_0_g128_f32_data, "main", 3, sizeof(vk_op_binary_push_constants), {1024, 1, 1}, {}, 1);
    ...
    ggml_vk_create_pipeline(device, device->pipeline_cpy_f32_quant[GGML_TYPE_Q1_0_G128], "cpy_f32_q1_0_g128", cpy_f32_q1_0_g128_len, cpy_f32_q1_0_g128_data, "main", 2, sizeof(vk_op_unary_push_constants), {32, 1, 1}, {}, 1);
...
#define SET_ROWS(itype) \
        ...
        ggml_vk_create_pipeline(device, device->pipeline_set_rows ## itype [GGML_TYPE_Q1_0_G128], "set_rows_q1_0_g128" #itype, set_rows_q1_0_g128 ## itype ## _len, set_rows_q1_0_g128 ## itype ## _data, "main", 3, sizeof(vk_op_binary_push_constants), {1, 1, 1}, {1}, 1, true); \
...
#undef SET_ROWS
    ...
    ggml_vk_create_pipeline(device, device->pipeline_cpy_quant_f32[GGML_TYPE_Q1_0_G128], "cpy_q1_0_g128_f32", cpy_q1_0_g128_f32_len, cpy_q1_0_g128_f32_data, "main", 2, sizeof(vk_op_unary_push_constants), {(uint32_t)ggml_blck_size(GGML_TYPE_Q1_0_G128), 1, 1}, {}, 1);
...
#undef CREATE_GLU
    ...
    ggml_vk_create_pipeline(device, device->pipeline_fwht, "fwht_op", fwht_op_len, fwht_op_data, "main", 2, 2 * sizeof(uint32_t), {32, 1, 1}, {}, 1);
...
static vk_matmul_pipeline ggml_vk_get_mul_mat_mat_pipeline(ggml_backend_vk_context * ctx, ggml_type src0_type, ggml_type src1_type, ggml_prec prec) {
    ...
    // family (IQ3_KS/IQ4_KS/IQ4_KSS/IQ2_KT/IQ4_KT) — are wired with per-type standalone
...
static bool ggml_vk_dim01_contiguous(const ggml_tensor * tensor) {
    // Use ggml_row_size to handle row_meta types (IQ3_KS, IQ4_KS, IQ4_KSS, IQ2_KT, IQ4_KT)
    // where each row has a fixed-size preamble that breaks the naive formula.
    return
...
static void ggml_vk_mul_mat_q_f16(ggml_backend_vk_context * ctx, vk_context& subctx, const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst, bool disable_split_k) {
    ...
    // Use ggml_nbytes so the buffer descriptor covers row_meta bytes prepended per row
    // by IK row_meta_size types (IQ3_KS, IQ4_KS, IQ4_KSS, IQ2_KT, IQ4_KT).
...
static void ggml_vk_turbo_wht(ggml_backend_vk_context * ctx, vk_context& subctx, const ggml_tensor * src0, ggml_tensor * dst) {
    ...
    // Element layout: one workgroup of 128 threads processes one WHT group of
    // group_size elements. n_groups = ne / group_size workgroups total.
        ...
        case GGML_OP_MUL_MAT_ID:
            {
                ...
                switch (src0_type) {
                    ...
                    case GGML_TYPE_IQ5_K:
                    case GGML_TYPE_IQ6_K:
                    // Phase 5b-1b KS/KL family + P3a IQ2_KT: IQ3_KS / IQ4_KS / IQ4_KSS / IQ2_KT / IQ4_KT / IQ2_KL
        ...
        case GGML_OP_DUP:
            {
                ...
                if (src0_type == GGML_TYPE_F32) {
                    ...
                    case GGML_TYPE_Q8_0:
                    case GGML_TYPE_IQ4_NL:
                        // GGML_TYPE_TURBOQ{3,4}_0 NOT supported here: the
                        // non-SET_ROWS quantize() path doesn't apply WHT;
                        // KV cache writes route through SET_ROWS instead.
                        return true;
                    default:
                        break;
                    }
