...
#define FA_TYPE_TURBOQ5_0 64u
#define FA_TYPE_TURBOQ6_0 65u
...
uint fa_block_elems(uint ty) {
    switch (ty) {
        ...
        case FA_TYPE_TURBOQ5_0: return uint(QUANT_K_TURBOQ5_0);
        case FA_TYPE_TURBOQ6_0: return uint(QUANT_K_TURBOQ6_0);
