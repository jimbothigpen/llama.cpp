...
void matmul_shaders(bool fp16, MatMulIdType matmul_id_type, bool coopmat, bool coopmat2, bool f16acc, bool dot2 = false) {
    ...
    for (const auto& tname : type_names) {
        ...
        if ((tname == "q1_0") || (tname == "q4_0") || (tname == "q4_1") || (tname == "q5_1") || (tname == "iq1_s") || (tname == "iq1_m") || (tname == "iq2_xxs") || (tname == "iq2_xs") || (tname == "iq2_s") || (tname == "iq2_kt") || (tname == "iq3_kt"))
            load_vec_quant = "8";
        ...
        // or mul_mmq backing. IQ2_K/IQ3_K/IQ4_K/IQ5_K/IQ6_K/IQ2_KT/IQ4_KT/IQ3_KT have a native
        // mul_mm path (see mul_mm_funcs.glsl) and fall through instead of being skipped here.
        // IQ4_KSS / IQ1_KT / IQ2_KL: row-meta weight-only types.
        // Standalone mul_mat_vec_iq*_k*.comp shaders handle them; no mul_mm backing.
        if (tname == "iq4_kss" || tname == "iq1_kt" || tname == "iq2_kl") {
            continue;
        }
        if (coopmat2 && (tname == "iq4_ks" || tname == "iq5_ks" || tname == "iq2_ks" || tname == "iq3_ks" || tname == "iq2_k" || tname == "iq3_k" ||
                          tname == "iq4_k" || tname == "iq5_k" || tname == "iq6_k" || tname == "iq2_kt" || tname == "iq4_kt" || tname == "iq3_kt")) {
            continue;
        }
