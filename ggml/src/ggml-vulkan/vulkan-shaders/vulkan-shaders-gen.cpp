...
void matmul_shaders(bool fp16, MatMulIdType matmul_id_type, bool coopmat, bool coopmat2, bool f16acc, bool dot2 = false) {
    ...
    for (const auto& tname : type_names) {
        ...
        if ((tname == "q1_0") || (tname == "q4_0") || (tname == "q4_1") || (tname == "q5_1") || (tname == "iq1_s") || (tname == "iq1_m") || (tname == "iq2_xxs") || (tname == "iq2_xs") || (tname == "iq2_s") || (tname == "iq2_kt"))
            load_vec_quant = "8";
        else if ((tname == "q5_0") || (tname == "q8_0") || (tname == "q2_k") || (tname == "q4_k") || (tname == "q5_k") || (tname == "iq3_xxs") || (tname == "iq3_s") || (tname == "iq4_xs") || (tname == "iq4_nl") || (tname == "iq4_ks") || (tname == "iq5_ks") || (tname == "iq3_ks") || (tname == "mxfp4") || (tname == "nvfp4"))
            load_vec_quant = "4";
...
void process_shaders() {
    ...
    for (const auto& tname : type_names) {
        ...
        // IQ2_K / IQ3_K / IQ4_K use standalone per-type f32/f16 matvec shaders only;
    ...
    for (std::string t : {"f32", "f16", "bf16", "q1_0", "q4_0", "q4_1", "q5_0", "q5_1", "q8_0", "iq4_nl", "turboq2_0", "turboq3_0", "turboq4_0", "turboq5_0", "turboq6_0", "turboq8_0", "turboq2_tcq", "turboq3_tcq", "kv_oscar_int2"}) {
    ...
    string_to_spv("fwht",            "fwht.comp",        {});

    // TurboQuant Walsh-Hadamard Transform compute shader (forward+inverse via direction push constant)
    ...
    string_to_spv("fwht_op", "fwht_op.comp", {});
...
void write_output_files() {
    ...
    for (const auto& tname : type_names) {
        // IQ2_K / IQ3_K / IQ4_K: no Q8_1 matvec shaders (mul_mat_vecq_funcs.glsl has no
        // DATA_A_IQ{2,3,4}_K implementation); skip declaration of q8_1 symbols for these types.
