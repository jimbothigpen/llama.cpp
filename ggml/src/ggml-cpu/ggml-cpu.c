...
static void ggml_vec_dot_turboq2_0_f32(int n, float * GGML_RESTRICT s, size_t bs,
...
static void ggml_vec_dot_turboq4_0_f32(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc);
static void ggml_vec_dot_turboq8_0_f32(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc);
static void ggml_vec_dot_turboq5_0_f32(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc);
static void ggml_vec_dot_turboq6_0_f32(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc);
static void ggml_vec_dot_wht3_0_q8_0(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc);
static void ggml_vec_dot_wht4_0_q8_0(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc);
static void ggml_vec_dot_wht5_0_q8_0(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc);
static void ggml_vec_dot_wht6_0_q8_0(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc);
static void ggml_vec_dot_wht8_0_q8_0(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc);
static void ggml_vec_dot_wq3_tcq_f32(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc);
...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TURBOQ8_0] = {
        .from_float               = (ggml_from_float_t) quantize_row_turboq8_0_ref,
        .vec_dot                  = (ggml_vec_dot_t) ggml_vec_dot_turboq8_0_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    [GGML_TYPE_TURBOQ5_0] = {
        .from_float               = (ggml_from_float_t) quantize_row_turboq5_0_ref,
        .vec_dot                  = (ggml_vec_dot_t) ggml_vec_dot_turboq5_0_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    [GGML_TYPE_TURBOQ6_0] = {
        .from_float               = (ggml_from_float_t) quantize_row_turboq6_0_ref,
        .vec_dot                  = (ggml_vec_dot_t) ggml_vec_dot_turboq6_0_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    // TCQ CPU traits — stub from_float only (Viterbi encode is GPU-only;
    // CPU set_rows on this type writes norm + zero bitstream).
    ...
    [GGML_TYPE_WHT4_0] = {
        .from_float               = (ggml_from_float_t) quantize_row_wht4_0_ref,
        .vec_dot                  = (ggml_vec_dot_t) ggml_vec_dot_wht4_0_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_WHT5_0] = {
        .from_float               = (ggml_from_float_t) quantize_row_wht5_0_ref,
        .vec_dot                  = (ggml_vec_dot_t) ggml_vec_dot_wht5_0_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_WHT6_0] = {
        .from_float               = (ggml_from_float_t) quantize_row_wht6_0_ref,
        .vec_dot                  = (ggml_vec_dot_t) ggml_vec_dot_wht6_0_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_WHT8_0] = {
        .from_float               = (ggml_from_float_t) quantize_row_wht8_0_ref,
        .vec_dot                  = (ggml_vec_dot_t) ggml_vec_dot_wht8_0_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_WQ3_TCQ] = {
...
// WQ3_TCQ vec_dot: dequantize WQ3 weight block to f32 (FWHT trellis decode), dot f32.
static void ggml_vec_dot_wq3_tcq_f32(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc) {
    GGML_ASSERT(nrc == 1);
...
// TurboQuant8 vec_dot: dequantize turboq8 block to f32, then dot with f32 operand.
static void ggml_vec_dot_turboq8_0_f32(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc) {
    GGML_ASSERT(nrc == 1);
...
// TurboQuant5 vec_dot: dequantize turboq5 block to f32, then dot with f32 operand.
static void ggml_vec_dot_turboq5_0_f32(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc) {
    GGML_ASSERT(nrc == 1);
...
// TurboQuant6 vec_dot: dequantize turboq6 block to f32, then dot with f32 operand.
static void ggml_vec_dot_turboq6_0_f32(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc) {
    GGML_ASSERT(nrc == 1);
...
// WHT3_0 vec_dot: dequantize wht3_0 block to f32, then dot with q8_0.
...
// WHT4_0 vec_dot: dequantize wht4_0 block to f32, then dot with q8_0.
...
// WHT5_0 vec_dot: dequantize wht5_0 block to f32, then dot with q8_0.
// TODO: optimize with SIMD intrinsics
static void ggml_vec_dot_wht5_0_q8_0(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc) {
...
// WHT6_0 vec_dot: dequantize wht6_0 block to f32, then dot with q8_0.
// TODO: optimize with SIMD intrinsics
static void ggml_vec_dot_wht6_0_q8_0(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc) {
...
// WHT8_0 vec_dot: dequantize wht8_0 block to f32, then dot with q8_0.
// TODO: optimize with SIMD intrinsics
static void ggml_vec_dot_wht8_0_q8_0(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc) {
