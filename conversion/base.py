...
class TextModel(ModelBase):
    ...
    def set_gguf_parameters(self):
        ...
        if (rope_type := rope_params.get("rope_type")) is not None:
            ...
            if rope_type == "linear" and rope_factor is not None:
                ...
                # Proportional RoPE: only a fraction of head dims are rotated; the unrotated
                # dims get very large frequencies (effectively frozen).  The actual scaling is
                # encoded in per-layer ROPE_FREQS freq-factor tensors generated by
                # generate_extra_tensors() — no rope_scaling_type key is needed in the GGUF.
                pass
            else:
    ...
    def get_vocab_base_pre(self, tokenizer) -> str:
        ...
        if chkhsh == "d30d75d9059f1aa2c19359de71047b3ae408c70875e8a3ccf8c5fba56c9d8af4":
            ...
            res = "qwen35"
        if chkhsh == "5443db1dd4d335caa66939d14402b8478216befbad11990fd0c2724fb6e59d09":
