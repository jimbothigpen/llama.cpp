...
#
# Usage:
#   ./run_pilot.sh                       # defaults to the interim 35B on :8083
#   BASE_URL=http://127.0.0.1:8083 MODEL=qwen36-35b ./run_pilot.sh
#   MODEL=qwopus35-9b BASE_URL=http://127.0.0.1:8085 ./run_pilot.sh
#
