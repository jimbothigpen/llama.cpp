...
static ggml_type ggml_type_from_name(const std::string & s) {
    ...
    if (s == "turboq2") {
        return GGML_TYPE_TURBOQ2_0;
    }
    if (s == "turboq3") {
        return GGML_TYPE_TURBOQ3_0;
    }
    if (s == "turboq4") {
        return GGML_TYPE_TURBOQ4_0;
    }
    if (s == "turboq8") {
        return GGML_TYPE_TURBOQ8_0;
    }
    if (s == "turboq5") {
        return GGML_TYPE_TURBOQ5_0;
    }
    if (s == "turboq6") {
        return GGML_TYPE_TURBOQ6_0;
    }
    if (s == "turboq2_tcq") {
    ...
    if (s == "turboq2_innerq") {
        return GGML_TYPE_TURBOQ2_INNERQ;
    }
    if (s == "turboq3_innerq") {
