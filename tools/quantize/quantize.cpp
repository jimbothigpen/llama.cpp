...
static const std::vector<quant_option> QUANT_OPTIONS = {
    ...
    { "WHT3_0",   LLAMA_FTYPE_MOSTLY_WHT3_0,   " 4.00 bpw WHT-rotated",             },
    { "WHT4_0",   LLAMA_FTYPE_MOSTLY_WHT4_0,   " 5.00 bpw WHT-rotated",             },
    ...
    { "WHT_MIX",  LLAMA_FTYPE_MOSTLY_WHT_MIX,  "~4.25 bpw imatrix-mixed WHT3_0..8_0, imatrix required",},
    ...
    { "IQ5_KS",   LLAMA_FTYPE_MOSTLY_IQ5_KS,   " 5.25 bpw ik_llama row-meta 5-bit", },
    { "IQ3_KS",   LLAMA_FTYPE_MOSTLY_IQ3_KS,   " 3.1875 bpw ik_llama row-meta",     },
    { "IQ2_KS",   LLAMA_FTYPE_MOSTLY_IQ2_KS,   " 2.1875 bpw ik_llama row-meta 2-bit small",},
    { "IQ4_KSS",  LLAMA_FTYPE_MOSTLY_IQ4_KSS,  " 4.0 bpw ik_llama row-meta ss",     },
    { "IQ1_KT",   LLAMA_FTYPE_MOSTLY_IQ1_KT,   " 1.75 bpw ik_llama row-meta trellis 1-bit",},
    ...
    { "IQ6_K",    LLAMA_FTYPE_MOSTLY_IQ6_K,    " 6.625 bpw ik_llama 6-bit",         },
    { "IQ2_KL",   LLAMA_FTYPE_MOSTLY_IQ2_KL,   " 2.6875 bpw ik_llama row-meta large",},
