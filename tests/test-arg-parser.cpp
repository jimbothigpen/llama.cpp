...
static void test(void) {
    ...
    argv = {"binary_name", "--no-host"};
    assert(true == common_params_parse(argv.size(), list_str_to_char(argv).data(), params, LLAMA_EXAMPLE_COMMON));
    assert(params.no_host == true);
    ...
    argv = {"binary_name", "-ctk", "turboq3", "-ctv", "f16"};
    assert(true == common_params_parse(argv.size(), list_str_to_char(argv).data(), params, LLAMA_EXAMPLE_COMMON));
    assert(params.cache_type_k == GGML_TYPE_TURBOQ3_0);
    ...
    argv = {"binary_name", "-ctkd", "turboq3", "-ctvd", "q4_0"};
    assert(true == common_params_parse(argv.size(), list_str_to_char(argv).data(), params, LLAMA_EXAMPLE_SPECULATIVE));
    assert(params.speculative.draft.cache_type_k == GGML_TYPE_TURBOQ3_0);
